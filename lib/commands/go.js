...
const KICKOFF = 'Inicie o Lumen para documentar este sistema agora (use a skill "lumen").';
...
export default async function go() {
  ...
  console.log(chalk.hex('#f5c518')(`\n  Abrindo ${chosen.name} e iniciando a documentação...\n`));
  const res = spawnSync(chosen.cmd, [KICKOFF], { stdio: 'inherit', cwd: projectRoot });
  if (res.error) {
