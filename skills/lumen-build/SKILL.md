...
1. Confirme que existem tasks em `.compozy/tasks/<feature>/task_*.md` (geradas pelo `lumen-tasks` no formato do motor). Se não houver, aborte apontando `lumen-tasks`.
...
Se acusar erro de formato, peça ao `lumen-tasks` para corrigir antes de prosseguir.
...
`Próximo: lumen-review <feature> (revisar o código) ou lumen-verify <feature> (conferir regressão). Digite CONTINUAR.`
