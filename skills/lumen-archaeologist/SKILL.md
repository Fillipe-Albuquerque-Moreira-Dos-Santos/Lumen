---
name: lumen-archaeologist
description: Analisa profundamente o código do projeto legado módulo a módulo — extrai algoritmos, fluxos de controle, estruturas de dados e dicionário de dados. Use na fase de escavação de uma análise de engenharia lumen, após o lumen-scout.
license: MIT
...
Leia `.lumen/plan.md` (módulos a analisar) e `.lumen/context/surface.json` (contexto do Scout).
