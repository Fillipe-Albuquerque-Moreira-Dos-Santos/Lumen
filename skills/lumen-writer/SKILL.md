...
- **Ancore no código real:** ao detalhar comportamento, confirme contra os artefatos do Archaeologist/Detective e, em dúvida, releia o código. Toda afirmação 🟢 é rastreável a `arquivo:linha`.
