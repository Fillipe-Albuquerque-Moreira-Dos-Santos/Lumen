...
> Gerado pelo `lumen-ground` a partir de `_lumen_docs/`.
> Input fundamentado para `lumen-techspec`. Verdade confirmada — não re-explore o que está resolvido aqui.

## Stack e padrões do sistema

> O `lumen-techspec` usa isto para **sugerir o mesmo stack/arquitetura** na criação, para a feature se encaixar.
...
Próximo: `lumen-techspec <feature>` — este pack é seu input fundamentado; não re-explore o que já está confirmado aqui.
