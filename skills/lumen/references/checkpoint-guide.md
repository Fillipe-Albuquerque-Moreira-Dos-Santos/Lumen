# Guia de Checkpoints — .lumen/state.json

O Lumen é o único agente que **escreve** no state.json. Os demais agentes apenas leem.
...
> "[Nome], vou pausar aqui para preservar o contexto. Tudo está salvo em `.lumen/state.json`. Digite `lumen` em uma nova sessão para continuar de onde paramos."
