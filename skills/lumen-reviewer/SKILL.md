---
name: lumen-reviewer
description: Revisa criticamente as especificações geradas pelo lumen-writer — encontra inconsistências, reclassifica confiança e gera perguntas para validação humana. Use na fase de revisão de uma análise de engenharia lumen.
license: MIT
