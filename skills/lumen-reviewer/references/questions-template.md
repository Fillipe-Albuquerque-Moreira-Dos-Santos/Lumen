# Template — _lumen_docs/questions.md
...
**Spec afetada:** [`_lumen_docs/<unit>/{requirements|design|tasks}.md`]
...
2. Avisar ao Revisor quando terminar (digitar `lumen` ou "respondi as perguntas")
...
**Spec afetada:** [`_lumen_docs/auth/requirements.md`]
...
**Spec afetada:** [`_lumen_docs/orders/requirements.md`]
