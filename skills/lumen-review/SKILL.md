---
name: lumen-review
description: Quinto passo do modo Construir. Revisa o código gerado e corrige em rodadas, usando o review do motor real (Compozy) — interno ou de provedores (CodeRabbit, GitHub). Use depois do lumen-build, antes de fechar a feature.
...
`Feature revisada. Para fechar o ciclo, rode lumen-verify <feature> e depois /lumen (re-extração) para confirmar que nada de 🟢 regrediu.`
