...
Você cria o PRD da feature: o **quê** e o **porquê**, nunca o **como**. O como é do `lumen-techspec`.
...
Confirme o caminho do `prd.md` e diga: `Próximo: lumen-techspec <feature>. Digite CONTINUAR.`
